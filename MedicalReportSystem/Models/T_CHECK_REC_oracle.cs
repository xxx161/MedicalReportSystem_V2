...
{
    public class T_CHECK_REC_oracle
    {
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        public string? CheckAuditTime { get; set; }
        ...
        public string? CheckReportDate { get; set; }
        ...
        public string? SymptomStartTime { get; set; }

        /// <summary>
        /// 症状停止日期时间
        /// </summary>
        [Column("symptom_stop_time")]
        public string? SymptomStopTime { get; set; }
